...
<main id="product-delete">
  <div class="container my-4">
    <div class="d-flex flex-column justify-content-center border rounded">
      <form method="POST" action="<?= urlPath('admin/product-management/destroy/' . $product->product_id) ?>" id="product-delete-form" class="d-flex flex-column justify-content-center align-items-center p-3">
