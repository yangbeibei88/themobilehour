...
<main id="category-delete">
  <div class="container my-4">
    <div class="d-flex flex-column justify-content-center border rounded">
      <form method="POST" action="/themobilehour/admin/category-management/destroy/<?= $category->category_id ?>" id="category-delete-form" class="d-flex flex-column justify-content-center align-items-center p-3">
